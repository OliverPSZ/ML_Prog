...
Priors0 = repelem(1/params.k,params.k);                                                   % Initialize priors
[labels0, Mu0] = kmeans(X,params.k,params.init,params.d_type,params.max_iter_init,false); % Initialize labels and means through K-Means

for i=1:params.k
    labels_idx = find(labels0==i);                                                        % Get indexes of datapoints labeled as the current k
    Sigma0(:,:,i) = compute_covariance(X(:,labels_idx), Mu0(:,i), params.cov_type);       % Initialize Covariance matrices
end
