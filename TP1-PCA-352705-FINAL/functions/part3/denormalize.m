...
switch normalization
    ...
    case "none"
        ...
        Xinversed = X;                                  % Return data in case it wasn't normalized
    
    case "minmax"

        Xinversed = (X.*(param2 - param1))+param1;      % Obtain denormalization from minmax
        
    case "zscore"

        Xinversed = (X.*(param2))+param1;               % Obtain denormalization from zscore
